...
mod shader {
    ...
    void main() {
        ...
        vec3 texture_rgb = linear_from_srgba(texture2D(u_sampler, v_tc)); // TODO: sRGBA aware sampeler, see linear_from_srgb;
        gl_FragColor = vec4(v_rgba.rgb * texture_rgb, texture_srgba.a * v_rgba.a);
    }
    "#;
